    ...
    <script>
        $('.rol').click(function() {
            ...
            if (input_rol_value == 0) {
                ...
                $('#mensajeRol').replaceWith( "<h3 class='text-center border-bottom mb-4' id='mensajeRol'>{{__('general.Alquiler por horas')}}</h3>");
