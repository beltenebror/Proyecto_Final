<footer class="section footer bg-dark mt-4"  >
    <div class="container text-light">
        <div class="row row-40 wow fadeIn">
            ...
            <div class="col-md-6 col-lg-4">
            <h5 class="title ">CONOCE</h5>
                <a>Nuestra política de procesamiento de datos.</a><br>
                <a>Terminos y condiciones.</a><br>
                <a>Política de privacidad.</a><br>
                <a>Política de cookies.</a><br>
                <a>Aviso Legal.</a>
            </div>
      ...
      <!-- Rights-->
        ...
        <p style="text-align: center">Todos los derechos Reservados. Diseñado y desarrollado por Cintia Cabrera Gamaza</p>
    </div>
</footer>